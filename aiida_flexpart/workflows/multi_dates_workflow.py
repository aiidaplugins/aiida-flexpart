...
class FlexpartMultipleDatesWorkflow(engine.WorkChain):
    ...
    def define(cls, spec):
        ...
        spec.input('simulation_dates', valid_type=orm.List, help="A list of the starting dates of the simulations")
        spec.input('locations', valid_type=orm.Dict, help="Dictionary of locations properties.")
        spec.input('meteo_inputs', valid_type=orm.Dict, help="Meteo models input params.")
