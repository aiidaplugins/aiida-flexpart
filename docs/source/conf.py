# -*- coding: utf-8 -*-
#
# Sphinx configuration for aiida-flexpart
#
...
release = aiida_flexpart.__version__
...
html_use_opensearch = 'http://aiida-flexpart.readthedocs.io'
...
htmlhelp_basename = 'aiida-flexpart-doc'
